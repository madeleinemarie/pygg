document.addEventListener('DOMContentLoaded', function() {
    ...
    $('tr#category-row td:contains("Loans")').closest('tr').css('background-color','wheat');
    ...
    $("td#category-color[data-category='Loans']").css('background-color','wheat')
    ...
    $("div#category-color[data-category='Loans']").css('background-color','wheat')
});